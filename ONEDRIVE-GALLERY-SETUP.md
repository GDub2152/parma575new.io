...
```bat
rclone lsd "onedrive:Parma575 Website Photos"
```
...
```powershell
Get-Content "$env:APPDATA\rclone\rclone.conf" -Raw | Set-Clipboard
```

This places the complete configuration on your clipboard.
